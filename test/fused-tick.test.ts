...
class FakeMarket {
  ...
  leverages: number[] = [];
  candleCloses() { return []; }
  candleBars5m(): { ts: number; high: number; low: number }[] { return []; }
  candleBars1h(): { ts: number; high: number; low: number }[] { return []; }
